...
<body>
  ...
  <header id="layout-header">
	...
	<article id="${titulo.id}" itemscope>
		  <header id="product-highlight" class="clearfix">
		    <div id="product-overview" class="container">
		      ...
		      <h1 class="product-title" itemprop="name">${titulo.titulo}</h1>
	...
	<div class="container">
	  ...
	  <section class="data product-detail">
	    ...
	    <p>Número de páginas: <span>${titulo.paginas}</span></p>
	    <p></p>
	    <p>Data de publicação: ${titulo.dataLancamento} </p>
